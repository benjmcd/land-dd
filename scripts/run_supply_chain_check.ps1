...
def validate_ci() -> None:
    ...
    require("actions/checkout@v4" in steps_text, "supply-chain job must checkout repo")
    require("actions/setup-python@v5" in steps_text, "supply-chain job must setup Python")
