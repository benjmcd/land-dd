...
| Empirical qualification | `docs/adr/0004-empirical-qualification-control-plane.md`, `plans/2026-06-21-empirical-qualification-adoption.md`, `state/QUALIFICATION_PARAMETERIZATION_BACKLOG.md`, future `config/qualification/**`, future `schemas/qualification/**`, future `state/EMPIRICAL_QUALIFICATION_STATUS.yaml` | Canonical empirical-validity control plane once the spine lands; backlog records blocked owner/source/AOI decisions, readiness/authority gates report into qualification, and `P0` remains blocked until owner decisions and empirical evidence are frozen |
