...
| Empirical qualification | `docs/adr/0004-empirical-qualification-control-plane.md`, `plans/2026-06-21-empirical-qualification-adoption.md`, future `config/qualification/**`, future `schemas/qualification/**`, future `state/EMPIRICAL_QUALIFICATION_STATUS.yaml` | Canonical empirical-validity control plane once the spine lands; readiness/authority gates report into it and `P0` remains blocked until owner decisions and empirical evidence are frozen |
