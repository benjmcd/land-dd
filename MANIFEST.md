...
| Private MVP readiness | `config/private_mvp_beta_readiness.yaml`, `scripts/run_private_mvp_readiness_check.ps1`, `scripts/run_private_mvp_readiness_check.sh`, `scripts/private_mvp_readiness_check.py` | Private beta gate catalog separating DS-017/hosted-production blockers from the selected NC county private-MVP utility proof, including selected-county source scope, county manifest scope, and source-provenance expectations |
