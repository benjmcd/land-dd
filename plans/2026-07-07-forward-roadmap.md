...
- **Drop from the plan entirely:** hosted production / Level 10 (OAuth/OIDC, registry publication, billing, external secret-manager — old B9), arbitrary-parcel external intake, and external-user access. These are no longer future work.
