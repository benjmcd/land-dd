...
```powershell
python .\scripts\ui_runtime_smoke.py --base-url $env:LAND_DD_UI_SMOKE_BASE_URL --reviewer-id fixture-reviewer --reviewer-token fixture-token-123 --operator-case-id BUN-slope
```
