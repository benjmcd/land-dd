...
Stop-and-record reconciliation: the bare-UNKNOWN removal was surfaced as an explicit implementation blocker before the freeze was applied, and was resolved by orchestrator authorization (disclosed to the owner after the fact) -- not a pre-change owner directive and not a silent agent edit. See the 2026-07-06 owner value-level ratification below.

2026-07-06 owner value-level ratification: benjmcd, via orchestrator escalation of the above provenance gap, explicitly ratified the frozen flood unknown_states = [SOURCE_FAILED, OUTSIDE_COVERAGE, STALE, CONFLICTING] at value level and directed this provenance correction. Independent adversarial verification (Codex thread 019f2153) confirmed no pre-change owner value-level directive removed UNKNOWN; the 2026-07-06 removal was orchestrator-authorized. This 2026-07-06 owner ratification supplies the value-level authority the 2026-07-06 correction lacked. It changes no frozen value (the four-state list is unchanged), no threshold, no scope, no safety posture; P0 remains NOT_RUN (BLOCKED=0 NOT_RUN=21). For the record, the over-attribution was committed twice -- introduced at freeze time (PR #191, 0c53023f) and re-introduced by the 2026-07-06 doc-completeness pass (PR #194, b86f177a) -- and this correction rewrites both sentences.
